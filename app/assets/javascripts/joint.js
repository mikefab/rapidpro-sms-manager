        ...
        if (opt.deep) {
            ...
            _.each(this.difference(links, embeddedCells), function(cell) {
                ...
                if (opt.outbound) {
                    ...
                    if (source && source.id && _.find(embeddedCells, {
                        id: source.id
                    })) {
                        links.push(cell);
                ...
                if (opt.inbound) {
                    ...
                    if (target && target.id && _.find(embeddedCells, {
                        id: target.id
                    })) {
                        links.push(cell);
                    }
    ...
    toFront: function(opt) {
        ...
        if (this.collection) {
            ...
            if (opt.deep) {
                ...
                var cells = this.getEmbeddedCells({
                    deep: true,
                    breadthFirst: true
                });
                _.each(cells, function(cell) {
...
joint.dia.ElementView = joint.dia.CellView.extend({
    ...
    prepareEmbedding: function() {
        ...
        _.invoke(this.paper.model.getConnectedLinks(this.model, {
            deep: true
        }), 'toFront', {
            ui: true
        });
        ...
        parentId && this.paper.model.getCell(parentId).unembed(this.model, {
            ui: true
        });
    },
    ...
    processEmbedding: function(opt) {
        ...
        if (newCandidateView && newCandidateView != prevCandidateView) {
            ...
            prevCandidateView && prevCandidateView.unhighlight(null, {
                embedding: true
            });
            this._candidateEmbedView = newCandidateView.highlight(null, {
                embedding: true
            });
        }
        ...
        if (!newCandidateView && prevCandidateView) {
            ...
            prevCandidateView.unhighlight(null, {
                embedding: true
            });
    ...
    finalizeEmbedding: function() {
        ...
        if (candidateView) {
            ...
            candidateView.model.embed(this.model, {
                ui: true
            });
    ...
    onEndModelChange: function(endType, endModel, opt) {
        ...
        if (endModel) {
            ...
            if (opt.isLoop && opt.translateBy &&
                this.model.isEmbeddedIn(endModel) && !_.isEmpty(this.model.get('vertices'))) {
